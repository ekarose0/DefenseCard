...
public class CardManager : MonoBehaviour
{
    ...
    [Space]
    [Header("Deck Info")]
    [SerializeField] List<CardSO> activeDeck = new List<CardSO>(4); //라운드에 따라 활성화되는 문양을 넣어주는 리스트
    [SerializeField] List<CardInfo> cardDeck = new List<CardInfo>(52); //추가된 문양의 카드 각각의 정보를 저장하는 리스트
